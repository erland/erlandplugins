...
sub webPages {
	my %pages = (
		...
		"TrackStat/selectstatistics\.(?:htm|xml)" => \&handleWebSelectStatistics,
		"TrackStat/saveselectstatistics\.(?:htm|xml)" => \&handleWebSaveSelectStatistics,
		"TrackStat/selectfavourites\.(?:htm|xml)" => \&handleWebSelectFavourites,
		"TrackStat/saveselectfavourites\.(?:htm|xml)" => \&handleWebSaveSelectFavourites
	);
