...
package Plugins::MultiLibrary::ConfigManager::LibraryWebAdminMethods;

use strict;
use Plugins::MultiLibrary::ConfigManager::WebAdminMethods;
our @ISA = qw(Plugins::MultiLibrary::ConfigManager::WebAdminMethods);
