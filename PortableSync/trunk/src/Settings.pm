...
package Plugins::PortableSync::Settings;

use strict;
use base qw(Plugins::PortableSync::BaseSettings);
...
my $log   = logger('plugin.portablesync');
...
sub page {
	return 'plugins/PortableSync/settings/basic.html';
}

sub currentPage {
	return Slim::Utils::Strings::string('PLUGIN_PORTABLESYNC_SETTINGS');
}
...
sub handler {
	...
	if ($paramRef->{'saveSettings'}) {
		Plugins::PortableSync::Plugin::getConfigManager()->initWebAdminMethods();
	}	
	return $result;
}
