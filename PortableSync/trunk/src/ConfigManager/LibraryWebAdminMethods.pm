...
package Plugins::PortableSync::ConfigManager::LibraryWebAdminMethods;

use strict;
use Plugins::PortableSync::ConfigManager::WebAdminMethods;
our @ISA = qw(Plugins::PortableSync::ConfigManager::WebAdminMethods);
